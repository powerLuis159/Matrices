========================================================================
    APLICACIÓN DE CONSOLA: multiplicacion de matrices Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación multiplicacion de matrices.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación multiplicacion de matrices.


multiplicacion de matrices.vcxproj
...
multiplicacion de matrices.vcxproj.filters
...
multiplicacion de matrices.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado multiplicacion de matrices.pch y un archivo de tipos precompilados llamado StdAfx.obj.
